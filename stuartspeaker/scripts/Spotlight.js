...
var Spotlight = {
  ...
  Init: function() {
    ...
    this.Container.style.display =
      ""; /*un-hiding it. Hidden incase no js on page*/
    ...
    this.Masks[1].style.height = this.Masks[2].style.height =
      this.SQUARE_SIZE + "px";
  ...
  UpdateMask: function(posx, posy) {
    ...
    if (posx > this.CANVAS_WIDTH - this.HALF_SQUARE)
      posx = this.CANVAS_WIDTH - this.HALF_SQUARE;
    if (posy < 0) posy = 0;
    if (posy > this.CANVAS_HEIGHT - this.SQUARE_SIZE)
      posy = this.CANVAS_HEIGHT - this.SQUARE_SIZE;
    ...
    this.Masks[3].style.height =
      this.CANVAS_HEIGHT - (posy + this.SQUARE_SIZE) + "px";
    ...
    this.Masks[2].style.width =
      this.CANVAS_WIDTH - (posx + this.HALF_SQUARE) + "px";
