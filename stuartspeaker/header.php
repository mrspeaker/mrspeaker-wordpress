...
<head profile="http://gmpg.org/xfn/11">
	...
	<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/scripts/jquery.wavey.js"></script>-->
...
<div id="lol">
	...
	Keep your eye out for <a href="http://www.twitter.com/mrspeaker">Mr Speaker</a> and <a href="http://www.twitter.com/twalve">@twalve</a>'s frightfully good book, <a href="http://www.sitepoint.com/books/jquery1/">jQuery: Novice to Ninja</a> - in stores NOW!</div>
<div id="outerWrapper">
	...
	<div id="header">
		...
		<?php /*<a href="<?php echo get_settings('home') ?>/" title="<?php bloginfo('name') ?>">
			<div id="compy"></div>
		</a>
		<a href="<?php echo get_settings('home') ?>/" title="<?php bloginfo('name') ?>">
